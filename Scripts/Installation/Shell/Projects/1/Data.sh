...
if [ "$cmsg" = "Y" -o "$cmsg" = "y" ]; then
    ...
    read -p "! Enter the absolute path to your dataset directory (Not including the COVID-19 Radiography Database directory: " dpath
    read -p "! Enter the absolute path to your dataset directory (Not including the COVID19-AI-Quantum-Tensorflow directory: " rpath
